...
function SignupFormComponent() {
  ...
  type FormValues = EnterpriseForm & Partial<EmployeeForm>
...
// ✅ SEND USER TO BACKEND TO SAVE IN MYSQL
...
await axios.post(`${API_URL}/api/users/signup`, {
  ...
  email: values.email,
  company_name: role === "employee"
  ? companies.find(c => c.value === values.company)?.label
    : `${values.firstName} ${values.lastName}`, 
  role: role,
});

  console.log("✅ User saved in MySQL");
} catch (err) {
  console.error("❌ Failed to save user in MySQL:", err);
}

      localStorage.setItem('firstName', values.firstName);
      localStorage.setItem('lastName', values.lastName);

  // you can decide to return here if you want to block signups that don't save:
  // return;
